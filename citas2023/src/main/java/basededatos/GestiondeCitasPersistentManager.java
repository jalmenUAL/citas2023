...
public class GestiondeCitasPersistentManager extends PersistentManager {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(basededatos.Cita.class);
		aMetadataSources.addAnnotatedClass(basededatos.Cita_Activa.class);
		aMetadataSources.addAnnotatedClass(basededatos.Cita_Realizada.class);
		aMetadataSources.addAnnotatedClass(basededatos.Asunto.class);
		aMetadataSources.addAnnotatedClass(basededatos.Cliente.class);
		aMetadataSources.addAnnotatedClass(basededatos.Fecha.class);
	}
