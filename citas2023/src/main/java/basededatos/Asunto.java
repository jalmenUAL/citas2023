...
public class Asunto implements Serializable {
	...
	@Transient
	public final basededatos.CitaSetCollection de_la_cita = new basededatos.CitaSetCollection(this, _ormAdapter,
			ORMConstants.KEY_ASUNTO_DE_LA_CITA, ORMConstants.KEY_CITA_ES_PARA, ORMConstants.KEY_MUL_ONE_TO_MANY);
