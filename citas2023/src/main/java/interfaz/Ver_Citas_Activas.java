...
public class Ver_Citas_Activas extends Ver_Citas {
	/*
	 * private event _posponer_Cita; private event _dar_por_realizada_Cita;
	 */
	public Usuario _usuario;
	// public Vector<Ver_Citas_Activas_item> _item = new
	// Vector<Ver_Citas_Activas_item>();
	...
	public void Dar_por_realizada_Cita() {
		...
		if (realizada) {
			...
			Notification.show("No hay ninguna cita a la que dar por realizada");
		cargar_citas_activas();
	}

	public void cargar_citas_activas() {

		List<Cita_Activa> ca = usu.Cargar_Citas_Activas();
	...
	public void cambiarFecha() {
		...
		if (cambiada) {
			...
			Notification.show("No hay ninguna cita que modificar");
		this.getCambiarFecha().setVisible(false);
		this.getNuevaFecha().setVisible(false);
